...
export const defaultJokes: DadJoke[] = [
  ...
  { id: 'j3', joke: "I used to hate facial hair...", punchline: "But then it grew on me." },
  { id: 'j4', joke: "What do you call a fake noodle?", punchline: "An impasta!" },
  { id: 'j5', joke: "Why did the scarecrow win an award?", punchline: "He was outstanding in his field!" },
  { id: 'j6', joke: "I only know 25 letters of the alphabet.", punchline: "I don't know Y." },
  { id: 'j7', joke: "What do you call a fish without eyes?", punchline: "A fsh!" },
  { id: 'j8', joke: "Why do fathers take an extra pair of socks when they go golfing?", punchline: "In case they get a hole in one!" },
  { id: 'j9', joke: "I'm afraid for the calendar.", punchline: "Its days are numbered." },
